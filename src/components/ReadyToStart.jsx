    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={() => navigate("/")} className="bg-primary text-white px-5 sm:px-6 py-3 rounded-lg hover:bg-blue-500 transition-all duration-300 shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_20px_60px_rgb(0,0,0,0.15)] hover:scale-105 hover:-translate-y-1 transform-gpu min-h-[44px] min-w-[44px]">
            Back to Home
          </button>
        </div>
      </div>
