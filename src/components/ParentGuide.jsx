      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            <Link to="/" className="p-2 hover:bg-blue-100 rounded-lg min-h-[44px] min-w-[44px] flex items-center justify-center">
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors ${
                  activeSection === section.id ? "bg-green-600 text-white" : "bg-white text-gray-700 hover:bg-blue-100"
                }`}
              >
        ...
        <div className="bg-green-600 rounded-lg p-6 text-white mt-8">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              className="flex items-center gap-2 bg-white text-green-600 px-4 py-2 rounded-lg font-medium hover:bg-blue-100 transition-colors"
            >
            ...
            <a
              ...
              className="flex items-center gap-2 bg-green-700 text-white px-4 py-2 rounded-lg font-medium hover:bg-blue-500 transition-colors"
            >
